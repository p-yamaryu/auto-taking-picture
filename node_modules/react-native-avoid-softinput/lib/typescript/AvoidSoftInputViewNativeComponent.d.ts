...
declare type SoftInputEventData = Readonly<{
    softInputHeight: Int32;
}>;
declare type SoftInputAppliedOffsetEventData = Readonly<{
    appliedOffset: Int32;
}>;
declare type SoftInputEasing = 'easeIn' | 'easeInOut' | 'easeOut' | 'linear';
